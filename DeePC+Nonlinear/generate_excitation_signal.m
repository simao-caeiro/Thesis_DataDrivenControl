...
% exc_param.T = Td;
% PRBS_signal = idinput(exc_param.T,'rbs',[0 1],[-1 1]);
...
% exc_param.rolld_exc_signal = circshift(exc_param.rolld_exc_signal, rolld_PRBS_shift_d);
% exc_param.pitchd_exc_signal = idinput(exc_param.T,'prbs',[0 1],[-pitchd_exc_amp pitchd_exc_amp]);
% exc_param.pitchd_exc_signal = circshift(exc_param.pitchd_exc_signal, pitchd_PRBS_shift_d);
