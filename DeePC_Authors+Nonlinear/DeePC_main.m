...
%     Tini);
 ...
 %% Save Results
% filename = "C:\Users\simao\OneDrive\Ambiente de Trabalho\GitHub\Thesis\DeePC_tests_z_down\Saved_Results\Squared_Wave_Model_eulerd\Model1\Nonlinear_noise_drag.mat";
% 
% save(filename,"param","total_thrust_cmd","body_rates_cmd",...
%     "full_state_act","full_state_meas","r_out","solve_time_out","run_time");
