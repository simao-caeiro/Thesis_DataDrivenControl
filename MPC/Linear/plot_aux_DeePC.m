...
% test_run_full_state_act = reshape(test_run_full_state_act,...
%     size(test_run_full_state_act,1),size(test_run_full_state_act,3));
% 
% test_run_full_state_meas = reshape(test_run_full_state_meas,...
%     size(test_run_full_state_meas,1),size(test_run_full_state_meas,3));
