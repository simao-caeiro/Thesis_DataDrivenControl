function output = MPC_Optimizer(ref, full_state_meas)
...
Xd_mpc(:,k_aux_mpc) = full_state_meas(1:9);
...
dUopt(:,:,k_aux_mpc) = reshape(-(mpc_param.K*xk - mpc_param.Ky*Yb) ,mpc_param.nu,mpc_param.N);
