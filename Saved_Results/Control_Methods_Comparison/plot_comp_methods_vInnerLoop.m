...
% saveFigAsPDF(myFigure1,'Figures_PDF/Inner_Loop_LQR_vs_DeePC_vs_MPC_pos');
% saveFigAsPDF(myFigure2,'Figures_PDF/Inner_Loop_LQR_vs_DeePC_vs_MPC_ang');