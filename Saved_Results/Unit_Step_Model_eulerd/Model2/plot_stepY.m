...
% saveFigAsPDF(myFigure1,'Figures_PDF/XY_stepY_model2');
% saveFigAsPDF(myFigure2,'Figures_PDF/Z_stepY_model2');
% saveFigAsPDF(myFigure3,'Figures_PDF/Euler_stepY_model2');
...
% saveFigAsPDF(myFigure4,'Figures_PDF/Position_stepY_model2');
% saveFigAsPDF(myFigure5,'Figures_PDF/Orientation_stepY_model2');
