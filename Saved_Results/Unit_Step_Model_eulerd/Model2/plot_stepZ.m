...
% ylabel('Position [m]') 
% xlabel('Time [s]')
% legend('X_{nonlinear}','X_{linear}','Y_{nonlinear}','Y_{linear}','Ref','Location','northeast')
% grid on
% xlim([0 8])
% ylim([0.8 1.2])
% 
...
% saveFigAsPDF(myFigure1,'Figures_PDF/XY_stepZ_model2');
% saveFigAsPDF(myFigure2,'Figures_PDF/Z_stepZ_model2');
% saveFigAsPDF(myFigure3,'Figures_PDF/Euler_stepZ_model2');
...
xlim([0 8])
ylim([-2.5 -0.5])
legend('Nonlinear','Linear','Ref','Location','northeast')
grid on
...
% saveFigAsPDF(myFigure4,'Figures_PDF/Position_stepZ_model2');
% saveFigAsPDF(myFigure5,'Figures_PDF/Orientation_stepZ_model2');