...
from Optim_noise import optim_DeePC_noise, DeePC_cl_noise, optim_SPC_noise,\
                        SPC_cl_noise
...
#---------------------- Data Collection ----------------------#
u0 = np.zeros((3,1))
U_L, Y_L = data_collection(u0, sys, Td, L, 1, sig_w)
...
S_spc, opt_x_num_spc, opt_p_num_spc = optim_SPC_noise(y_r, Q, R, Tf, Td, T_ini, U_p, \
                                                Y_p, Y_f, U_f, n_u, n_y)

res_SPC, y_optim_spc = SPC_cl_noise(sys, T_ini,Td, opt_p_num_spc, opt_x_num_spc,\
                                    S_spc, y_r, R, Q, sig_w, n_y)
...
S_deepc, opt_x_num_dpc, opt_p_num_dpc = optim_DeePC_noise(y_r, Q, R, Tf, Td, T_ini, \
                                                    U_p, Y_p, Y_f, U_f, n_u, n_y)

res_deePC, y_optim_deePC, g = DeePC_cl_noise(sys, T_ini,Td, opt_p_num_dpc,\
                                    opt_x_num_dpc, S_deepc, y_r, R, Q, sig_w, n_y)
